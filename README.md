...
| **Green Candle Trade** | A paper trading simulator for the Indian stock market (NSE). Allows users to buy/sell stocks with a mock 1 Cr portfolio and track their performance. | `React.js` `Tailwind CSS` `TypeScript` `Zustand` `Recharts` | [**Live Demo**](https://green-candle-trade.vercel.app/) • [**GitHub**](https://github.com/vijay2898AD/Green-Candle-Trade) |
